...
## Formula 5 — source lines 104-106

$$
(X,R),
$$

## Formula 6 — source lines 110-112

$$
X
$$

## Formula 7 — source lines 116-118

$$
R\subseteq X\times X
$$

## Formula 8 — source lines 132-134

$$
(X,R)
$$

## Formula 9 — source lines 138-140

$$
\mathrm{SubRel}(X,R)
$$

## Formula 10 — source lines 144-146

$$
(X',R')
$$

## Formula 11 — source lines 150-152

$$
X'\subseteq X,
$$

## Formula 12 — source lines 154-156

$$
R'\subseteq R\cap(X'\times X').
$$

## Formula 13 — source lines 168-170

$$
q:X\to Y.
$$

## Formula 14 — source lines 174-176

$$
\mathrm{Im}(q)=Y.
$$

## Formula 15 — source lines 180-182
...
## Formula 18 — source lines 206-208

$$
\mathrm{rec}:Y\to \mathrm{SubRel}(X,R).
$$

## Formula 19 — source lines 212-214

$$
\mathrm{rec}(y)=(X_y^{\mathrm{rec}},R_y^{\mathrm{rec}}),
$$

## Formula 20 — source lines 218-220

$$
X_y^{\mathrm{rec}}\subseteq q^{-1}(y),
$$

## Formula 21 — source lines 222-224

$$
R_y^{\mathrm{rec}} \subseteq R\cap \bigl(X_y^{\mathrm{rec}}\times X_y^{\mathrm{rec}}\bigr).
$$

## Formula 22 — source lines 234-236

$$
\Pi=(X,R,q,\mathrm{rec}),
$$

## Formula 23 — source lines 240-242

$$
(X,R)
$$

## Formula 24 — source lines 246-248

$$
q:X\to Y
$$

## Formula 25 — source lines 252-254

$$
\mathrm{rec}:Y\to \mathrm{SubRel}(X,R)
$$

## Formula 26 — source lines 260-262

$$
\text{carrier},
$$

## Formula 27 — source lines 264-266

$$
\text{relation},
$$

## Formula 28 — source lines 268-270

$$
\text{reading},
$$

## Formula 29 — source lines 272-274

$$
\text{recoverability}.
$$

## Formula 30 — source lines 284-286

$$
\mathrm{rec}(y) = \bigl(q^{-1}(y),\ R|_{q^{-1}(y)}\bigr),
$$

## Formula 31 — source lines 290-292

$$
R|_{q^{-1}(y)} = R\cap(q^{-1}(y)\times q^{-1}(y)).
$$

## Formula 32 — source lines 302-304

$$
\Pi=(X,R,q,\mathrm{rec})
$$

## Formula 33 — source lines 310-312
...
## Formula 42 — source lines 374-376
...
## Formula 45 — source lines 397-399

$$
\pi(a)=I,
$$

## Formula 46 — source lines 401-403

$$
\pi(-a)=I.
$$

## Formula 47 — source lines 407-409

$$
\mathrm{Im}(\pi)=\mathbf I.
$$

## Formula 48 — source lines 413-415

$$
a,\quad -a.
$$

## Formula 49 — source lines 419-421
...
## Formula 52 — source lines 443-445

$$
\mathrm{rec}_P(I)=(P,R_P).
$$

## Formula 53 — source lines 455-457
...
## Formula 57 — source lines 475-477

$$
\mathrm{rec}_P(I)=(P,R_P).
$$

## Formula 58 — source lines 483-487
...
## Formula 59 — source lines 491-493
...
## Formula 61 — source lines 517-519

$$
\pi(a)=\pi(-a)=I.
$$

## Formula 62 — source lines 530-532

$$
f:P\to P
$$

## Formula 63 — source lines 536-540
...
## Formula 64 — source lines 544-546

$$
\pi\circ f=\pi.
$$

## Formula 65 — source lines 550-552

$$
\mathrm{Aut}_I(P,R_P).
$$

## Formula 66 — source lines 565-567

$$
\mathrm{id}_P(a)=a,
$$

## Formula 67 — source lines 569-571

$$
\mathrm{id}_P(-a)=-a.
$$

## Formula 68 — source lines 575-577

$$
\tau(a)=-a,
$$

## Formula 69 — source lines 579-581
...
## Formula 72 — source lines 598-600
...
## Formula 75 — source lines 625-627

$$
\tau^2=\mathrm{id}_P.
$$

## Formula 76 — source lines 631-633

$$
\tau^2(a)=\tau(-a)=a,
$$

## Formula 77 — source lines 635-637

$$
\tau^2(-a)=\tau(a)=-a.
$$

## Formula 78 — source lines 643-645

$$
\tau^2=\mathrm{id}_P
$$

## Formula 79 — source lines 651-653

$$
a\mapsto -a\mapsto a,
$$

## Formula 80 — source lines 655-657
...
## Formula 83 — source lines 685-689
...
## Formula 84 — source lines 695-699
...
## Formula 85 — source lines 703-707
...
## Formula 86 — source lines 713-717
...
## Formula 87 — source lines 721-725
...
## Formula 91 — source lines 751-753

$$
q_1(0)=q_1(1)=I.
$$

## Formula 92 — source lines 757-759

$$
\mathrm{rec}_1(I)=(Q_1,R_1^{\mathrm{pol}}).
$$

## Formula 93 — source lines 763-765

$$
\Pi_1^{\mathrm{coord}} = (Q_1,R_1^{\mathrm{pol}},q_1,\mathrm{rec}_1).
$$

## Formula 94 — source lines 769-773
...
## Formula 95 — source lines 777-781
...
## Formula 96 — source lines 785-787

$$
(c\times c)(R_P)=R_1^{\mathrm{pol}},
$$

## Formula 97 — source lines 789-791

$$
\mathrm{rec}_1(I)=(c(P),(c\times c)(R_P)).
$$

## Formula 98 — source lines 803-805

$$
Q_n=\mathbb{F}_2^n.
$$

## Formula 99 — source lines 809-811

$$
x=(x_1,\ldots,x_n)
$$

## Formula 100 — source lines 817-819

$$
0^n=(0,\ldots,0)
$$

## Formula 101 — source lines 825-827
...
## Formula 106 — source lines 864-870
...
## Formula 107 — source lines 879-881

$$
e_i=(0,\ldots,0,1,0,\ldots,0)
$$

## Formula 108 — source lines 887-889

$$
\sigma_i(x)=x+e_i.
$$

## Formula 109 — source lines 895-897

$$
x\mapsto x+1.
$$

## Formula 110 — source lines 901-903

$$
x\mapsto x+e_i
$$

## Formula 111 — source lines 915-917
...
## Formula 114 — source lines 933-935

$$
Q_n=\mathbb{F}_2 e_n\oplus Q_{n-1}.
$$

## Formula 115 — source lines 939-941
...
## Formula 119 — source lines 972-976
...
## Formula 120 — source lines 980-982

$$
\varepsilon=0,
$$

## Formula 121 — source lines 986-988

$$
x=y.
$$

## Formula 122 — source lines 992-994

$$
y\in Q_{n-1}^*.
$$

## Formula 123 — source lines 998-1000

$$
x\in Q_{n-1}^*.
$$

## Formula 124 — source lines 1004-1006

$$
\varepsilon=1,
$$

## Formula 125 — source lines 1010-1012

$$
x=e_n+y.
$$

## Formula 126 — source lines 1016-1018

$$
y=0
$$

## Formula 127 — source lines 1022-1024

$$
x=e_n.
$$

## Formula 128 — source lines 1028-1030

$$
y\neq0
$$

## Formula 129 — source lines 1034-1036
...
## Formula 132 — source lines 1052-1054

$$
\text{new},
$$

## Formula 133 — source lines 1056-1058
...
## Formula 145 — source lines 1120-1122

$$
10,\ 11;
$$

## Formula 146 — source lines 1124-1126

$$
100,\ 101,\ 110,\ 111.
$$

## Formula 147 — source lines 1135-1137

$$
x=(x_1,\ldots,x_n)\in Q_n
$$

## Formula 148 — source lines 1141-1143
...
## Formula 151 — source lines 1166-1168

$$
011
$$

## Formula 152 — source lines 1179-1181

$$
q:X\to Y.
$$

## Formula 153 — source lines 1188-1190

$$
\Pi=(X,R,q,\mathrm{rec}),
$$

## Formula 154 — source lines 1202-1204

$$
\Pi=(X,R,q,\mathrm{rec}),
$$

## Formula 155 — source lines 1208-1210

$$
R
$$

## Formula 156 — source lines 1216-1218

$$
q=\mathrm{id}_X,
$$

## Formula 157 — source lines 1231-1233
...
## Formula 164 — source lines 1283-1285
...
## Formula 168 — source lines 1312-1314

$$
10
$$

## Formula 169 — source lines 1318-1320

$$
11
$$

## Formula 170 — source lines 1329-1333
...
## Formula 171 — source lines 1338-1340

$$
\sigma_1(x)=x+e_1.
$$

## Formula 172 — source lines 1344-1346

$$
\sigma_2(x)=x+e_2.
$$

## Formula 173 — source lines 1350-1355
...
## Formula 174 — source lines 1357-1362
...
## Formula 175 — source lines 1366-1368

$$
x\mapsto x+1.
$$

## Formula 176 — source lines 1377-1379

$$
\sigma_1\sigma_2=\sigma_2\sigma_1.
$$

## Formula 177 — source lines 1383-1385

$$
\sigma_1\sigma_2(x)=x+11.
$$

## Formula 178 — source lines 1390-1392

$$
\sigma_1\sigma_2(x) = \sigma_1(x+10) = x+10+01 = x+11.
$$

## Formula 179 — source lines 1396-1398

$$
\sigma_2\sigma_1(x) = \sigma_2(x+01) = x+01+10 = x+11.
$$

## Formula 180 — source lines 1402-1404

$$
\sigma_1\sigma_2=\sigma_2\sigma_1.
$$

## Formula 181 — source lines 1411-1413

$$
|x|.
$$

## Formula 182 — source lines 1420-1422
...
## Formula 188 — source lines 1455-1457

$$
|x+y|=1.
$$

## Formula 189 — source lines 1461-1463

$$
x+y=e_i
$$

## Formula 190 — source lines 1467-1469

$$
y=x+e_i.
$$

## Formula 191 — source lines 1473-1475

$$
y=x+e_i,
$$

## Formula 192 — source lines 1479-1481

$$
x+y=e_i
$$

## Formula 193 — source lines 1485-1487

$$
d_H(x,y)=1.
$$

## Formula 194 — source lines 1491-1493

$$
|x+y|=2.
$$

## Formula 195 — source lines 1497-1499

$$
11.
$$

## Formula 196 — source lines 1503-1505

$$
x+y=11,
$$

## Formula 197 — source lines 1509-1511

$$
y=x+11.
$$

## Formula 198 — source lines 1515-1517

$$
H_1^{(2)}
$$

## Formula 199 — source lines 1521-1523

$$
\sigma_1,\sigma_2.
$$

## Formula 200 — source lines 1527-1529

$$
x\mapsto \sigma_i(x)=x+e_i.
$$

## Formula 201 — source lines 1537-1539
...
## Formula 204 — source lines 1556-1558

$$
00\leftrightarrow 01,
$$

## Formula 205 — source lines 1560-1562

$$
01\leftrightarrow 11,
$$

## Formula 206 — source lines 1564-1566

$$
11\leftrightarrow 10,
$$

## Formula 207 — source lines 1568-1570

$$
10\leftrightarrow 00.
$$

## Formula 208 — source lines 1574-1582
...
## Formula 209 — source lines 1588-1590

$$
(Q_2,H_1^{(2)})\cong C_4.
$$

## Formula 210 — source lines 1606-1608

$$
\Pi_2^{2K_2} = (Q_2,H_2^{(2)},\mathrm{id}_{Q_2},\mathrm{rec}_{\mathrm{id}}).
$$

## Formula 211 — source lines 1612-1614

$$
(Q_2,H_2^{(2)})\cong 2K_2.
$$

## Formula 212 — source lines 1619-1621

$$
x\mapsto x+11.
$$

## Formula 213 — source lines 1625-1627

$$
00\leftrightarrow 11,
$$

## Formula 214 — source lines 1629-1631
...
## Formula 217 — source lines 1660-1662

$$
x=(x_2,x_1)
$$

## Formula 218 — source lines 1669-1671

$$
\chi:Q_2\to\mathbb{F}_2
$$

## Formula 219 — source lines 1675-1677

$$
\chi(x_2,x_1)=x_2+x_1.
$$

## Formula 220 — source lines 1681-1683

$$
\chi(00)=0,
$$

## Formula 221 — source lines 1685-1687

$$
\chi(11)=0,
$$

## Formula 222 — source lines 1689-1691

$$
\chi(01)=1,
$$

## Formula 223 — source lines 1693-1695

$$
\chi(10)=1.
$$

## Formula 224 — source lines 1702-1704
...
## Formula 230 — source lines 1741-1743

$$
01,10\in \chi^{-1}(1).
$$

## Formula 231 — source lines 1747-1749

$$
H_1^{(2)}
$$

## Formula 232 — source lines 1753-1755

$$
x_2+x_1.
$$

## Formula 233 — source lines 1762-1764
...
## Formula 240 — source lines 1802-1804

$$
\mathrm{rec}_\chi(1) = (\chi^{-1}(1),H_2^{(2)}|_{\chi^{-1}(1)}).
$$

## Formula 241 — source lines 1820-1822

$$
x\mapsto x+11.
$$

## Formula 242 — source lines 1826-1828

$$
\chi(x+11)=\chi(x).
$$

## Formula 243 — source lines 1833-1835

$$
x=(x_2,x_1).
$$

## Formula 244 — source lines 1839-1841

$$
x+11=(x_2+1,x_1+1).
$$

## Formula 245 — source lines 1845-1847

$$
\chi(x+11) = (x_2+1)+(x_1+1) = x_2+x_1+1+1 = x_2+x_1 = \chi(x).
$$

## Formula 246 — source lines 1862-1864

$$
0^n=(0,\ldots,0),
$$

## Formula 247 — source lines 1866-1868

$$
1^n=(1,\ldots,1).
$$

## Formula 248 — source lines 1872-1876
...
## Formula 249 — source lines 1880-1882
...
## Formula 256 — source lines 1933-1935
...
## Formula 259 — source lines 1959-1961
...
## Formula 262 — source lines 1983-1985

$$
(Q_2,R_{K_4}^{(2)})\cong K_4.
$$

## Formula 263 — source lines 1990-1994
...
## Formula 264 — source lines 1998-2000
...
## Formula 276 — source lines 2084-2086

$$
z=11.
$$

## Formula 277 — source lines 2098-2100
...
## Formula 280 — source lines 2116-2118

$$
(Q_2,R_{K_4-e}^{(2)})\cong K_4-e.
$$

## Formula 281 — source lines 2125-2127

$$
00\leftrightarrow 11.
$$

## Formula 282 — source lines 2131-2133

$$
00\leftrightarrow 01,
$$

## Formula 283 — source lines 2135-2137

$$
00\leftrightarrow 10,
$$

## Formula 284 — source lines 2139-2141

$$
11\leftrightarrow 01,
$$

## Formula 285 — source lines 2143-2145

$$
11\leftrightarrow 10,
$$

## Formula 286 — source lines 2147-2149

$$
01\leftrightarrow 10.
$$

## Formula 287 — source lines 2153-2155

$$
(Q_2,R_{K_4-e}^{(2)})\cong K_4-e.
$$

## Formula 288 — source lines 2163-2165
...
## Formula 291 — source lines 2179-2181

$$
00\leftrightarrow 10,
$$

## Formula 292 — source lines 2183-2185
...
## Formula 295 — source lines 2201-2203

$$
11\leftrightarrow 10,
$$

## Formula 296 — source lines 2205-2207

$$
01\leftrightarrow 10.
$$

## Formula 297 — source lines 2213-2215

$$
01\leftrightarrow 10.
$$

## Formula 298 — source lines 2221-2223

$$
R_{\Delta_{\wedge}} = R_{K_4-e}^{(2)} \cap (\Delta_{\wedge}\times\Delta_{\wedge}),
$$

## Formula 299 — source lines 2225-2227

$$
R_{\Delta_{\vee}} = R_{K_4-e}^{(2)} \cap (\Delta_{\vee}\times\Delta_{\vee}).
$$

## Formula 300 — source lines 2231-2235
...
## Formula 303 — source lines 2258-2260

$$
2K_2,
$$

## Formula 304 — source lines 2262-2264

$$
K_4,
$$

## Formula 305 — source lines 2266-2268

$$
K_4-e.
$$

## Formula 306 — source lines 2272-2274

$$
C_4
$$

## Formula 307 — source lines 2278-2280

$$
2K_2
$$

## Formula 308 — source lines 2284-2286

$$
K_4
$$

## Formula 309 — source lines 2290-2292

$$
K_4-e
$$

## Formula 310 — source lines 2302-2304

$$
\mathfrak C_2 = \left( Q_2, \Pi_2^{C_4}, \Pi_2^{2K_2}, \Pi_2^\chi, \Pi_2^{K_4}, \Pi_2^{K_4-e}, A_2 \right).
$$

## Formula 311 — source lines 2318-2320

$$
Q_3=\mathbb{F}_2^3.
$$

## Formula 312 — source lines 2324-2327
...
## Formula 314 — source lines 2343-2345
...
## Formula 323 — source lines 2407-2409

$$
1^3=111.
$$

## Formula 324 — source lines 2415-2417

$$
000
$$

## Formula 325 — source lines 2423-2425

$$
111
$$

## Formula 326 — source lines 2439-2441
...
## Formula 331 — source lines 2482-2484
...
## Formula 346 — source lines 2593-2595

$$
2^2-2=2.
$$

## Formula 347 — source lines 2601-2603
...
## Formula 350 — source lines 2626-2628

$$
000\leftrightarrow 111.
$$

## Formula 351 — source lines 2632-2636
...
## Formula 352 — source lines 2641-2643

$$
\overline{S_1^{(3)}}=S_2^{(3)},
$$

## Formula 353 — source lines 2645-2647

$$
\overline{S_2^{(3)}}=S_1^{(3)}.
$$

## Formula 354 — source lines 2652-2654

$$
|x|=1,
$$

## Formula 355 — source lines 2658-2660

$$
|x|=2,
$$

## Formula 356 — source lines 2664-2666

$$
S_1^{(3)}\leftrightarrow S_2^{(3)}.
$$

## Formula 357 — source lines 2670-2672

$$
001\leftrightarrow 110,
$$

## Formula 358 — source lines 2674-2676

$$
010\leftrightarrow 101,
$$

## Formula 359 — source lines 2678-2680
...
## Formula 362 — source lines 2717-2719

$$
x,y\in X_{\mathrm{adm}}
$$

## Formula 363 — source lines 2723-2729
...
## Formula 370 — source lines 2784-2788
...
## Formula 371 — source lines 2792-2794

$$
001\leftrightarrow 011,
$$

## Formula 372 — source lines 2796-2798

$$
011\leftrightarrow 010,
$$

## Formula 373 — source lines 2800-2802

$$
010\leftrightarrow 110,
$$

## Formula 374 — source lines 2804-2806

$$
110\leftrightarrow 100,
$$

## Formula 375 — source lines 2808-2810

$$
100\leftrightarrow 101,
$$

## Formula 376 — source lines 2812-2814

$$
101\leftrightarrow 001.
$$

## Formula 377 — source lines 2818-2820

$$
001 \leftrightarrow 011 \leftrightarrow 010 \leftrightarrow 110 \leftrightarrow 100 \leftrightarrow 101 \leftrightarrow 001.
$$

## Formula 378 — source lines 2824-2826

$$
(X_{\mathrm{adm}},R_1)\cong C_6.
$$

## Formula 379 — source lines 2831-2833

$$
(X_{\mathrm{adm}},R_1)\cong C_6.
$$

## Formula 380 — source lines 2851-2855
...
## Formula 381 — source lines 2859-2861

$$
(X_{\mathrm{adm}},R_2) \cong K_3\sqcup K_3.
$$

## Formula 382 — source lines 2866-2870
...
## Formula 383 — source lines 2874-2876

$$
d_H(x,y)=2.
$$

## Formula 384 — source lines 2882-2886
...
## Formula 385 — source lines 2890-2892

$$
d_H(x,y)=2.
$$

## Formula 386 — source lines 2898-2902
...
## Formula 387 — source lines 2906-2908

$$
d_H(x,y)=1
$$

## Formula 388 — source lines 2912-2914

$$
d_H(x,y)=3.
$$

## Formula 389 — source lines 2918-2920

$$
(X_{\mathrm{adm}},R_2) \cong K_3\sqcup K_3.
$$

## Formula 390 — source lines 2924-2926

$$
|E(R_2)|=6.
$$

## Formula 391 — source lines 2939-2943
...
## Formula 392 — source lines 2947-2949

$$
y=x+111.
$$

## Formula 393 — source lines 2953-2955

$$
S_1^{(3)} \leftrightarrow S_2^{(3)}.
$$

## Formula 394 — source lines 2959-2961

$$
001\leftrightarrow110,
$$

## Formula 395 — source lines 2963-2965

$$
010\leftrightarrow101,
$$

## Formula 396 — source lines 2967-2969

$$
100\leftrightarrow011.
$$

## Formula 397 — source lines 2973-2975

$$
(X_{\mathrm{adm}},R_3)\cong 3K_2.
$$

## Formula 398 — source lines 2980-2982

$$
x\in X_{\mathrm{adm}}
$$

## Formula 399 — source lines 2986-2988

$$
x+111
$$

## Formula 400 — source lines 2992-2994

$$
d_H(x,x+111)=3.
$$

## Formula 401 — source lines 2998-3000
...
## Formula 404 — source lines 3033-3035

$$
R_1,\quad R_2,\quad R_3
$$

## Formula 405 — source lines 3042-3044

$$
x,y\in X_{\mathrm{adm}}\subset Q_3
$$

## Formula 406 — source lines 3048-3050

$$
1,\quad 2,\quad 3.
$$

## Formula 407 — source lines 3058-3060

$$
\binom{|X_{\mathrm{adm}}|}{2} = \binom{6}{2} = 15.
$$

## Formula 408 — source lines 3064-3066

$$
|E(R_1)|=6,
$$

## Formula 409 — source lines 3068-3070

$$
|E(R_2)|=6,
$$

## Formula 410 — source lines 3072-3074

$$
|E(R_3)|=3.
$$

## Formula 411 — source lines 3078-3080
...
## Formula 414 — source lines 3101-3105
...
## Formula 415 — source lines 3109-3115
...
## Formula 416 — source lines 3119-3121

$$
C_6.
$$

## Formula 417 — source lines 3125-3127

$$
K_3\sqcup K_3.
$$

## Formula 418 — source lines 3131-3133

$$
3K_2.
$$

## Formula 419 — source lines 3144-3146

$$
001\leftrightarrow110,
$$

## Formula 420 — source lines 3148-3150

$$
010\leftrightarrow101,
$$

## Formula 421 — source lines 3152-3154

$$
100\leftrightarrow011.
$$

## Formula 422 — source lines 3158-3160

$$
\beta_1,\quad \beta_2,\quad \beta_3.
$$

## Formula 423 — source lines 3165-3167
...
## Formula 428 — source lines 3197-3199

$$
R_{12} = R_1\cup R_2.
$$

## Formula 429 — source lines 3203-3207
...
## Formula 430 — source lines 3211-3213

$$
(x,y)\in R_{12}
$$

## Formula 431 — source lines 3217-3219

$$
d_H(x,y)=1
$$

## Formula 432 — source lines 3223-3225
...
## Formula 435 — source lines 3243-3245

$$
y=x+111,
$$

## Formula 436 — source lines 3249-3253
...
## Formula 437 — source lines 3262-3264

$$
R_{12}
$$

## Formula 438 — source lines 3268-3270

$$
\Pi_{12} = \bigl( X_{\mathrm{adm}}, R_{12}, \mathrm{id}_{X_{\mathrm{adm}}}, \mathrm{rec}_{\mathrm{id}} \bigr).
$$

## Formula 439 — source lines 3274-3276
...
## Formula 442 — source lines 3304-3306

$$
V = V_1\sqcup V_2\sqcup V_3, \qquad |V_1|=|V_2|=|V_3|=2,
$$

## Formula 443 — source lines 3315-3317

$$
(X_{\mathrm{adm}},R_{12}) \cong K_{2,2,2}.
$$

## Formula 444 — source lines 3322-3324

$$
\beta_1,\beta_2,\beta_3
$$

## Formula 445 — source lines 3328-3330

$$
V_1,V_2,V_3
$$

## Formula 446 — source lines 3336-3338
...
## Formula 451 — source lines 3364-3370
...
## Formula 452 — source lines 3374-3376

$$
d_H(x,y)\neq 3.
$$

## Formula 453 — source lines 3380-3382

$$
x\neq y
$$

## Formula 454 — source lines 3386-3388

$$
d_H(x,y)=1
$$

## Formula 455 — source lines 3392-3394

$$
d_H(x,y)=2.
$$

## Formula 456 — source lines 3398-3400

$$
(x,y)\in R_{12}.
$$

## Formula 457 — source lines 3404-3406

$$
K_{2,2,2}.
$$

## Formula 458 — source lines 3411-3415
...
## Formula 459 — source lines 3419-3421

$$
|E(R_{12})| = |E(R_1)|+|E(R_2)| = 6+6 = 12.
$$

## Formula 460 — source lines 3425-3427

$$
2\cdot2=4
$$

## Formula 461 — source lines 3431-3433

$$
|E(K_{2,2,2})| = 3\cdot4 = 12.
$$

## Formula 462 — source lines 3449-3451
...
## Formula 473 — source lines 3516-3518

$$
(X_{\mathrm{adm}},R_{12}) \cong O_3^{(1)}.
$$

## Formula 474 — source lines 3523-3525

$$
(X_{\mathrm{adm}},R_{12}) \cong K_{2,2,2}.
$$

## Formula 475 — source lines 3529-3531

$$
K_{2,2,2} \cong O_3^{(1)}.
$$

## Formula 476 — source lines 3535-3537

$$
(X_{\mathrm{adm}},R_{12}) \cong O_3^{(1)}.
$$

## Formula 477 — source lines 3545-3547

$$
\mathcal O_{12} = \bigl( \Pi_{12}, [(X_{\mathrm{adm}},R_{12})\cong O_3^{(1)}] \bigr)
$$

## Formula 478 — source lines 3551-3553

$$
(X_{\mathrm{adm}},R_{12}) \cong O_3^{(1)}
$$

## Formula 479 — source lines 3561-3563

$$
\varphi:(X_{\mathrm{adm}},R_{12})\to O_3^{(1)}.
$$

## Formula 480 — source lines 3570-3572

$$
(X_{\mathrm{adm}},R_{12})
$$

## Formula 481 — source lines 3576-3578

$$
\beta_1,\quad \beta_2,\quad \beta_3.
$$

## Formula 482 — source lines 3582-3584

$$
E_1,\quad E_2,\quad E_3.
$$

## Formula 483 — source lines 3588-3590
...
## Formula 486 — source lines 3606-3610
...
## Formula 487 — source lines 3612-3616
...
## Formula 496 — source lines 3675-3677

$$
R_{12}=R_1\cup R_2.
$$

## Formula 497 — source lines 3683-3685

$$
(X_{\mathrm{adm}},R_1)\cong C_6.
$$

## Formula 498 — source lines 3689-3691

$$
(X_{\mathrm{adm}},R_2)\cong K_3\sqcup K_3.
$$

## Formula 499 — source lines 3695-3697

$$
d_H=1
$$

## Formula 500 — source lines 3701-3703

$$
d_H=2.
$$

## Formula 501 — source lines 3714-3716

$$
X_{\mathrm{adm}} = S_1^{(3)} \sqcup S_2^{(3)}.
$$

## Formula 502 — source lines 3720-3724
...
## Formula 503 — source lines 3728-3730
...
## Formula 506 — source lines 3752-3754

$$
X_{\mathrm{adm}}.
$$

## Formula 507 — source lines 3758-3760

$$
R_{12}=R_1\cup R_2
$$

## Formula 508 — source lines 3764-3766

$$
(X_{\mathrm{adm}},R_{12}) \cong O_3^{(1)}.
$$

## Formula 509 — source lines 3775-3777
...
## Formula 514 — source lines 3807-3809

$$
(x,y)\in R_{12},
$$

## Formula 515 — source lines 3819-3821

$$
C\subset X_{\mathrm{adm}}
$$

## Formula 516 — source lines 3825-3827

$$
|C\cap \beta_i|=1
$$

## Formula 517 — source lines 3831-3833

$$
i=1,2,3.
$$

## Formula 518 — source lines 3837-3839
...
## Formula 520 — source lines 3857-3861
...
## Formula 521 — source lines 3865-3867

$$
C\in \mathrm{Cham}(O_3);
$$

## Formula 522 — source lines 3869-3871

$$
C\subset X_{\mathrm{adm}}, \qquad |C|=3, \qquad C\ \mathrm{is\ a\ clique\ in}\ (X_{\mathrm{adm}},R_{12}).
$$

## Formula 523 — source lines 3876-3878

$$
C\in \mathrm{Cham}(O_3).
$$

## Formula 524 — source lines 3882-3884
...
## Formula 527 — source lines 3900-3902

$$
\Box
$$

## Formula 528 — source lines 3909-3911

$$
|\mathrm{Cham}(O_3)|=8.
$$

## Formula 529 — source lines 3916-3922
...
## Formula 530 — source lines 3926-3928

$$
|\mathrm{Cham}(O_3)| = 2\cdot 2\cdot 2 = 8.
$$

## Formula 531 — source lines 3930-3932

$$
\Box
$$

## Formula 532 — source lines 3945-3949
...
## Formula 533 — source lines 3953-3957
...
## Formula 534 — source lines 3959-3963
...
## Formula 535 — source lines 3965-3969
...
## Formula 544 — source lines 4028-4030

$$
\Phi:\mathrm{Cham}(O_3)\to Q_3
$$

## Formula 545 — source lines 4037-4039
...
## Formula 548 — source lines 4055-4057

$$
\mathrm{Cham}(O_3)\cong Q_3.
$$

## Formula 549 — source lines 4073-4075

$$
Q_n^{(1)}
$$

## Formula 550 — source lines 4079-4083
...
## Formula 551 — source lines 4090-4092

$$
C,D\in\mathrm{Cham}(O_3)
$$

## Formula 552 — source lines 4096-4098

$$
(C,D)\in R_{\mathrm{ch}}
$$

## Formula 553 — source lines 4102-4104

$$
C\neq D
$$

## Formula 554 — source lines 4108-4110

$$
|C\cap D|=2.
$$

## Formula 555 — source lines 4116-4118

$$
(\mathrm{Cham}(O_3),R_{\mathrm{ch}}) \cong Q_3^{(1)}.
$$

## Formula 556 — source lines 4123-4127
...
## Formula 557 — source lines 4133-4135

$$
\varepsilon_i=\delta_i.
$$

## Formula 558 — source lines 4139-4141

$$
|C_\varepsilon\cap C_\delta|=2
$$

## Formula 559 — source lines 4145-4147

$$
d_H(\varepsilon,\delta)=1.
$$

## Formula 560 — source lines 4151-4153

$$
(\mathrm{Cham}(O_3),R_{\mathrm{ch}}) \cong Q_3^{(1)}.
$$

## Formula 561 — source lines 4155-4157

$$
\Box
$$

## Formula 562 — source lines 4161-4163

$$
\mathrm{Cham}(O_3)\cong Q_3
$$

## Formula 563 — source lines 4167-4170
...
## Formula 564 — source lines 4181-4183

$$
V_O:=X_{\mathrm{adm}}.
$$

## Formula 565 — source lines 4187-4189
...
## Formula 568 — source lines 4205-4209
...
## Formula 569 — source lines 4211-4215
...
## Formula 574 — source lines 4255-4257

$$
\mathrm{Inc}_O \subset V_O\times C_O
$$

## Formula 575 — source lines 4261-4263

$$
(x,C)\in\mathrm{Inc}_O
$$

## Formula 576 — source lines 4267-4269

$$
x\in C.
$$

## Formula 577 — source lines 4275-4277

$$
(b_i^\eta,C_\varepsilon)\in\mathrm{Inc}_O
$$

## Formula 578 — source lines 4281-4283

$$
\varepsilon_i=\eta.
$$

## Formula 579 — source lines 4287-4291
...
## Formula 580 — source lines 4300-4302

$$
R_{12}
$$

## Formula 581 — source lines 4308-4310

$$
R_{12}\subset V_O\times V_O
$$

## Formula 582 — source lines 4316-4318

$$
R_{\mathrm{ch}}\subset C_O\times C_O
$$

## Formula 583 — source lines 4324-4326

$$
\mathrm{Inc}_O\subset V_O\times C_O
$$

## Formula 584 — source lines 4330-4332
...
## Formula 587 — source lines 4358-4360

$$
\varepsilon_i=\eta.
$$

## Formula 588 — source lines 4364-4366

$$
2\cdot 2=4.
$$

## Formula 589 — source lines 4370-4372

$$
24.
$$

## Formula 590 — source lines 4376-4378

$$
|C_O|\cdot 3 = 8\cdot 3 = 24,
$$

## Formula 591 — source lines 4380-4382

$$
|V_O|\cdot 4 = 6\cdot 4 = 24.
$$

## Formula 592 — source lines 4390-4392
...
## Formula 600 — source lines 4445-4447

$$
F_i^\eta.
$$

## Formula 601 — source lines 4451-4453

$$
\text{vertex of }O_3^{(1)} \longleftrightarrow \text{coordinate face of }Q_3.
$$

## Formula 602 — source lines 4462-4464
...
## Formula 606 — source lines 4487-4489
...
## Formula 609 — source lines 4511-4513

$$
(x,y)\in R_{12}
$$

## Formula 610 — source lines 4517-4519

$$
\mathrm{Star}(x)\cap\mathrm{Star}(y)\neq\varnothing.
$$

## Formula 611 — source lines 4523-4525

$$
|\mathrm{Star}(x)\cap\mathrm{Star}(y)|=2
$$

## Formula 612 — source lines 4529-4531
...
## Formula 618 — source lines 4568-4570

$$
\eta\neq \mu,
$$

## Formula 619 — source lines 4574-4578
...
## Formula 620 — source lines 4582-4584

$$
\mathrm{Star}(x)\cap\mathrm{Star}(y)=\varnothing.
$$

## Formula 621 — source lines 4590-4592

$$
i\neq j,
$$

## Formula 622 — source lines 4596-4600
...
## Formula 623 — source lines 4604-4606

$$
|\mathrm{Star}(x)\cap\mathrm{Star}(y)|=2.
$$

## Formula 624 — source lines 4610-4614
...
## Formula 625 — source lines 4616-4618

$$
\Box
$$

## Formula 626 — source lines 4622-4624

$$
(V_O,R_{12})
$$

## Formula 627 — source lines 4633-4635
...
## Formula 630 — source lines 4652-4654

$$
C,D\in C_O
$$

## Formula 631 — source lines 4658-4660

$$
(C,D)\in R_{\mathrm{ch}}
$$

## Formula 632 — source lines 4664-4666

$$
|\mathrm{Vert}(C)\cap\mathrm{Vert}(D)|=2.
$$

## Formula 633 — source lines 4671-4675
...
## Formula 637 — source lines 4699-4701

$$
\Box
$$

## Formula 638 — source lines 4710-4712
