...
- \(\operatorname{Rel}\) specifies the relation scheme;
...
lifts uniquely along \(\Phi^{-1}\) to a path in \(\operatorname{Cham}(O_3)\),
...
2. **Axial sector.**  
   ...
   \(\operatorname{span}\{d_i\oplus\chi_i\}\). This contributes \(4^3\) and \(9^3\).
